(self["webpackChunkwordpress_starter_kit"] = self["webpackChunkwordpress_starter_kit"] || []).push([["assets_js_pages_contact_js"],{
...
var FormValidate = function FormValidate(form, onSend) {
  ...
  var validate = function validate() {
    ...
    try {
      for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
        ...
        var dataMandatory = field.dataset.mandatory;
        ...
        var customSelect = field.closest('.custom-select');
  ...
  form.onsubmit = function (e) {
    e.preventDefault();
    var customSelectFields = form.querySelectorAll('.select-items > div');

    var _iterator4 = _createForOfIteratorHelper(customSelectFields),
        _step4;
    ...
    var errorsFields = form.querySelectorAll('*[aria-invalid=true]');
...
/* harmony default export */ __webpack_exports__["default"] = (function (el) {
  new _modules_formValidate__WEBPACK_IMPORTED_MODULE_0__.default(el, function () {
    el.submit();
  });
});
...
//# sourceMappingURL=8213efc2276401ed35c3.js.map