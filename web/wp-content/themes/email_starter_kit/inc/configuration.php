...
function theme_setup()
{
    ...
    add_image_size('medium', 150, 150, array('center', 'center'));
    add_image_size('151_151', 151, 151, array('center', 'center'));
    add_image_size('100_100', 100, 100, array('center', 'center'));
    add_image_size('304_171', 304, 171, array('center', 'center'));
    add_image_size('346_288', 346, 288, array('center', 'center'));
    add_image_size('590_491', 590, 491, array('center', 'center'));
    add_image_size('700_auto', 700, 0, array('center', 'center'));
    add_image_size('1168_657', 1168, 657, array('center', 'center'));
    add_image_size('1024_auto', 1024, 0, array('center', 'center'));
}
